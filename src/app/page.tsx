...
import {
  TipCrypButton,
  tipCrypButtonAttributes,
  tipCrypButtonSVGAttributes,
} from "./components/TipCrypButton";
...
<a href="${host}/tips?addr=${address}" target="_blank">
  <button style="${cssAttributesToString(tipCrypButtonAttributes)}">
    TipCryp
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white" style="${cssAttributesToString(tipCrypButtonSVGAttributes)}">
